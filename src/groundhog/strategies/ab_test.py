...
# --- Paired stats, vendored verbatim from groundhog.bench.stats -------------
# (feat/bench-harness). Kept byte-identical on purpose so the branches
# converge: once that branch merges, delete this block and
# `from groundhog.bench.stats import mean_std, paired_stats, PairedStats`.
